...
public class Main {
	...
	public static void main(String[] args)
	{
		...
		List<Block> ascendingBlockListCOPY = new ArrayList<Block>(ascendingBlockList);
		...
		switch (choice)
		{
			case 1 :
					for(int i=0; i<10; i++)
					{
						System.arraycopy(ascendingBlockListCOPY, 0, descendingBlockList, 0, ascendingBlockListCOPY.size());
